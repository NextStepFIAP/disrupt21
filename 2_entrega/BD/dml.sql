...
INSERT INTO t_nxt_personagem (id_personagem, nm_personagem, nm_ator, url_foto, dt_nascimento, ds_apresentacao, ds_en_apresentacao, nm_classificacao) 
VALUES (sq_nxt_personagem.NEXTVAL, 'Lorraine Baines McFly', 'Lea Thompson', 'url', TO_DATE('1938-01-01', 'YYYY-MM-DD'), 'Com um presente completamente diferente do ínicio desta história, Lorraine agora aparenta estar muito mais saudável e feliz com o seu casamento e enxerga George como um homem que ela sempre desejou.', 'apresentacao ingles', 'Secundário');
